...
def generate_launch_description():
      return LaunchDescription([
          ...
          DeclareLaunchArgument('GXGGA_KIAPI',  default_value='$GPGGA,092917.49,3539.10200,N,12823.92181,E,4,30,0.5,26.3,M,-22.6,M,,*7C'),
          DeclareLaunchArgument('GXGGA_KAIST',  default_value='$GNGGA,123740.49,3622.09894,N,12721.85503,E,1,08,2.2,74.9,M,94.9,M,,0000*4F'),
          DeclareLaunchArgument('GXGGA_YONGIN',  default_value='$GPGGA,071443.50,3717.74510,N,12712.42325,E,4,25,0.6,135.8,M,-19.1,M,,*43'),
                ...
                parameters=[
                  {
                    ...
                    # 'nmea_gga': LaunchConfiguration('GXGGA_KIAPI'),
                    'nmea_gga': LaunchConfiguration('GXGGA_KAIST'),
                    # 'nmea_gga': LaunchConfiguration('GXGGA_YONGIN'),

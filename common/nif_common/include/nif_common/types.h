...
#include "deep_orange_msgs/msg/marelli_summary.hpp"
...
enum SystemStatusCode : std::uint8_t {
  ...
  SYSTEM_WARNING = nif_msgs::msg::SystemHealthStatus::SYSTEM_WARNING,
...
enum NodeStatusCode : std::uint8_t {
  ...
  NODE_WARNING = nif_msgs::msg::NodeStatus::NODE_WARNING,
...
//! MARELLI
// using RCFlagSummary = deep_orange_msgs::msg::MarelliSummary;
// using OverrideRCFlagSummary = deep_orange_msgs::msg::MarelliSummary;
// static bool isTrackFlagInRange(
//     nif::common::msgs::RCFlagSummary::_marelli_track_flag_type track_flag) {
//   if (track_flag == RCFlagSummary::TRACK_FLAG_NULL ||
//       track_flag == RCFlagSummary::TRACK_FLAG_RED ||
//       track_flag == RCFlagSummary::TRACK_FLAG_FULL_COURSE_YELLOW ||
//       track_flag == RCFlagSummary::TRACK_FLAG_GREEN ||
//       track_flag == RCFlagSummary::TRACK_FLAG_WAVING_GREEN ||
//       track_flag == RCFlagSummary::TRACK_FLAG_CHECKERED)
//     return true;
//   return false;
// }

// static bool
// isVehFlagInRange(nif::common::msgs::RCFlagSummary::_marelli_vehicle_flag_type veh_flag) {
//   if (veh_flag == RCFlagSummary::VEH_FLAG_NULL ||
//       veh_flag == RCFlagSummary::VEH_FLAG_ORANGE ||
//       veh_flag == RCFlagSummary::VEH_FLAG_YELLOW ||
//       veh_flag == RCFlagSummary::VEH_FLAG_STOP ||
//       veh_flag == RCFlagSummary::VEH_FLAG_BLUE ||
//       veh_flag == RCFlagSummary::VEH_FLAG_BLACK ||
//       veh_flag == RCFlagSummary::VEH_FLAG_PURPLE ||
//       veh_flag == RCFlagSummary::VEH_FLAG_ENGINE_KILL || 
//       veh_flag == RCFlagSummary::VEH_FLAG_DEFENDER ||
//       veh_flag == RCFlagSummary::VEH_FLAG_ATTACKER)
//     return true;
//   return false;
...
static bool isMissionCodeInRange(
  ...
  if (mission_code == MissionStatus::MISSION_RACE ||
      ...
      mission_code == MissionStatus::MISSION_PIT_SLOW ||

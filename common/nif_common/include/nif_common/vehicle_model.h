 ...
 */
const double VEH_WHEEL_BASE = 2.98;
 ...
 */
// const double STEERING_RATIO = 14.75;
// const double STEERING_RATIO = 19.50;
const double STEERING_RATIO = 15.0; //Monza RC setup (240deg/16deg)

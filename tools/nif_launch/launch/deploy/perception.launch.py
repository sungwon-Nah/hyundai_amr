...
def generate_launch_description():
    ...
    nif_azimuth_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_share_file("nif_detection_fusion_nodes", 'launch/deploy.launch.py')
        )
    )

    nif_lidar_camera_fusion_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_share_file("nif_lidar_camera_fusion_nodes", 'launch/deploy.launch.py')
        )
    )

    yolov7_ros_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            get_share_file("yolov7_ros", 'launch/trt.launch.py')
        )
    )
    ...
    return LaunchDescription([
        ...
        nif_azimuth_launch,
        nif_lidar_camera_fusion_launch,
        yolov7_ros_launch,
])
...
def generate_launch_description():
    ...
    dbc_file_path = get_share_file(
        package_name='raptor_dbw_can', file_name='launch/CAN1-INDY-V11.dbc'
    )
...
# NIF CONTROL STACK ###############################################
    ...
    nif_joint_lqr_control_node = Node(
        ...
        remappings=[
            ...
            ('in_reference_path', '/wall_based_predictive_path'),
    ...
    nif_velocity_planning_node = Node(
        ...
        parameters=[{
            ...
            'max_ddes_vel_dt_green_flag' : 6.0,
...
### NIF WAYPOINT MANAGER END #############################
    ...
    nif_wall_detection_launch = IncludeLaunchDescription(
       PythonLaunchDescriptionSource(
           get_share_file("nif_points_preprocessor_nodes", 'launch/deploy.launch.py')
       )
   )
    fm_data_node = Node(
        package='fm_data',

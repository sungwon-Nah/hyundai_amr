...
public:
  ...
  // nif_msgs::msg::DynamicTrajectory velProfileWCollisionChecking( //! CES22023 COLLISION CHECKING
  ...
  //   const bool use_sat_, const double &spline_interval_, const bool find_overtake_, const double mission_max_vel_);

  nif_msgs::msg::DynamicTrajectory velProfileWCollisionChecking(  //! CES2022 COLLISION CHECKING
    const nav_msgs::msg::Odometry &odom_,
    const nav_msgs::msg::Path &target_path_,
    const nif_msgs::msg::DynamicTrajectory &oppo_predicted_path_,
    const double checking_dist_bound_, const double checking_time_bound_,
...
private:
  ...
  double m_constraint_max_accel_overtake;

...
velocity_profiler::velProfileWCollisionChecking(
  ...
  if (collision_time_filetered < 0.2) {
    std::cout << "Too risky. Set to 0.2 sec as default" << std::endl;
    collision_time_filetered = 0.2;
  }
        ...
        for (int oppo_traj_idx = 0;
          ...
          auto body_collision_pt =
              nif::common::utils::coordination::getPtGlobaltoBody(
                  ...
                  oppo_predicted_path_.trajectory_path.poses[oppo_traj_idx]
                      .pose);
          if (dist < collision_dist_filetered &&
              time_diff < collision_time_filetered &&
